...
# 
# ##### A separate analysis considering all the predictors was carried out but it resulted in decreasing the accuracy. Similarly, 
# 
# ##### Principal Component Analysis also reduces the accuracy.
# 
